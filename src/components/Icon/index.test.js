...
describe("Icon component", () => {
  describe("When a icon is created with name twitch", () => {
    const ValuePathIconTwitch = "327fbc38c8e878259c3ec35ef231517a";
    it("the icon contain this path hash value 327fbc38c8e878259c3ec35ef231517a", () => {
      render(<Icon name="twitch" />);
      expect(md5(screen.getByTestId("icon-twitch").getAttribute("d"))).toEqual(ValuePathIconTwitch);
    });
  });
  describe("When a icon is created with name facebook", () => {
    const ValuePathIconFacebook = "bbea4c9e40773b969fdb6e406059f853";
